# 3_Go to GEE and download data (image/s) for your AOI (data file/s will be downloaded to your Google Drive account)
...
task = ee.batch.Export.image.toDrive(image=img,     # an ee.Image object.
                                     ...
                                     description    = 'LST_MOD11A1_03022019_1030',
                                     folder         = 'gdrive_folder',
                                     fileNamePrefix = 'LST_MOD11A1_03022019_1030',
                                     scale          = 1000,
                                     crs='EPSG:4326')
task.start()
