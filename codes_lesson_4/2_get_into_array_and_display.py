...
def onclick(event):
   if event.xdata != None and event.ydata != None:
       ...
       textbox = 'Channel      Wavelength [\u00b5m]      Temp (\N{DEGREE SIGN}C)'  + \
        '  \n' + '----------------------------------------------------------'  + \
        '  \n' + 'CH04                     3.9                   ' + "{:.2f}".format(round[1]) + \
        '  \n' + 'CH05                     6.2                   ' + "{:.2f}".format(round[2]) + \
        '  \n' + 'CH06                     7.3                   ' + "{:.2f}".format(round[3]) + \
        '  \n' + 'CH07                     8.7                   ' + "{:.2f}".format(round[4]) + \
        '  \n' + 'CH08                     9.7                   ' + "{:.2f}".format(round[5]) + \
        '  \n' + 'CH09                     10.8                 '  + "{:.2f}".format(round[6]) + \
       ...
       # Draw new lines
       ax[1,0].plot([3.9,6.2,7.3,8.7,9.7,10.8,12,13.4], t[1:9], color='black', marker='o', linestyle='dashed')
