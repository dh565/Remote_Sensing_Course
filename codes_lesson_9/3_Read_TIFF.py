...
# that we already used before) and save the files  on your PC or Google Drive 
# folder if you use Google Colab.

# ------------------------------------------------------------------------------ #
# The polygon (shapefile) for the AOI is available in the GitHub folder 
# for this lesson.
# ------------------------------------------------------------------------------ #
...
NDVI = NDVI*0.0001  # data needs to be scaled for this product
...
LST = LST*0.02      # data needs to be scaled for this product
